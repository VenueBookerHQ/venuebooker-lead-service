...
urlpatterns = [
    ...
    url(r'^venues/(?P<pk>[0-9]+)/$', views.VenueUpdate.as_view(), name='venue-update'),  
    ...
    url(r'^eventcampaigns/(?P<pk>[0-9]+)/$', views.EventCampaignUpdate.as_view(), name='event_campaign-update'), 
