# -*- coding: utf-8 -*-
# Generated by Django 1.9.2 on 2017-02-14 17:59
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='event_campaign',
            name='venue',
            field=models.ForeignKey(default=0, on_delete=django.db.models.deletion.CASCADE, to='web_app.Venue'),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='venue',
        ...
        migrations.AddField(
            model_name='venue',
            name='organisation',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='web_app.Organisation'),
            preserve_default=False,
        ),
    ]
