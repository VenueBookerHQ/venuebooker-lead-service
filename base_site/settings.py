...
SOCIAL_AUTH_GOOGLE_OAUTH2_KEY = os.environ['GOOG_KEY']
SOCIAL_AUTH_GOOGLE_OAUTH2_SECRET = os.environ['GOOG_SECRET']
SOCIAL_AUTH_FACEBOOK_KEY = os.environ['FB_KEY']
SOCIAL_AUTH_FACEBOOK_SECRET = os.environ['FB_SECRET']
SOCIAL_AUTH_FACEBOOK_APP_NAMESPACE = os.environ['FB_NS']
SOCIAL_AUTH_FACEBOOK_SCOPE = ['email']
SOCIAL_AUTH_TWITTER_KEY = os.environ['TW_KEY']
SOCIAL_AUTH_TWITTER_SECRET = os.environ['TW_SECRET']
